...
package com.example.baseproject.util.mlkit.facedetector

import android.annotation.SuppressLint
import android.content.Context
import android.util.Log
import com.example.baseproject.util.mlkit.GraphicOverlay
import com.example.baseproject.util.mlkit.VisionProcessorBase
...
class FaceDetectorProcessor(
    ...
    init {
        ...
        Timber.e("Face detector options: $options")
    }
    ...
    override fun onSuccess(results: List<Face>, graphicOverlay: GraphicOverlay) {
        for (face in results) {
            checkFaceCentered(face, graphicOverlay)
            logExtrasForTesting(face)
        }
    }

    private fun checkFaceCentered(face: Face, graphicOverlay: GraphicOverlay) {
        if (
            face.headEulerAngleX < 12 && face.headEulerAngleX > -12 &&
